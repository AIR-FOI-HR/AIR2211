...
public class OdradeniZahvatService {
    ...
    public OdradeniZahvat AddOdradeniZahvat(OdradeniZahvat odradeniZahvat) { return odradeniZahvatRepository.save(odradeniZahvat); }

    public Long DeleteOdradeniZahvat(int specijalizacija, int zahvat, int stupanj) {
        if(OdradeniZahvatByIds(specijalizacija, zahvat, stupanj)!=null) { return odradeniZahvatRepository.deleteBySpecijalizacijaAndZahvatAndStupanj(specijalizacija, zahvat, stupanj); }
        else { return 0L; }
    }
    ...
    public OdradeniZahvat UpdateOdradeniZahvat(OdradeniZahvat updatedOdradeniZahvat) {
        ...
        if(odradeniZahvatZaUpdate.isEmpty()) { return null; }
        else { return odradeniZahvatRepository.save(updatedOdradeniZahvat); }
    }
